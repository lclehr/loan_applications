...
# Label encoding is performed for all non numerical columns as most ML models required numerical inputs
...
loan_data['Property_Area'] = loan_data['Property_Area'].map(property_area_dict)
...
loans_for_eval['Property_Area'] = loans_for_eval['Property_Area'].map(property_area_dict)
...
X_eval = loans_for_eval[['Gender', 'Married', 'Dependents', 'Education', 'Self_Employed', 'ApplicantIncome', 'CoapplicantIncome', 'LoanAmount', 'Loan_Amount_Term','Credit_History', 'Property_Area']]
